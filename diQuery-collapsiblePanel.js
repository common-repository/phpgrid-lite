...
function ConfigureCollapsiblePanel() {
    ...
    jQuery("<div class='collapsibleContainerTitle ui-widget-header box_open '><div>" + jQuery(this).attr("title") + "</div></div>").prependTo(jQuery(this));
...
function CollapsibleContainerTitleOnClick() {
	...
	jQuery(this).toggleClass("box_close");
